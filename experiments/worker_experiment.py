...
from src.cgprocess.layout_segmentation.datasets.train_dataset import CropDataset  # type: ignore
from src.cgprocess.layout_segmentation.processing import Preprocessing, CROP_SIZE, CROP_FACTOR  # type: ignore
...
def worker_experiment():
    ...
    dataset = CropDataset(preprocessing, image_path=f"{args.data_path}images/",
