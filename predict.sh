...
python src/layout_segmentation/predict.py -d data/PipelineTest/test -m models/model_neurips_dh_segment_3.0_best.pt -p 5760 7680 -t 0.6 -a dh_segment -s 0.5 -e -bt 200
