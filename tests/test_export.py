...
class TestClassExport:
    ...
    def test_get_reading_order(self):
        ...
        bottom right corner"""
        bbox_data = np.array([[1, 4, 1, 1, 10, 10, 5], [2, 9, 1, 100, 100, 105, 103], [3, 3, 1, 11, 10, 21, 15],
                              [4, 6, 15, 1, 25, 10, 5], [5, 6, 15, 11, 25, 21, 15], [6, 4, 1, 120, 10, 130, 125],
                              [7, 4, 11, 120, 25, 130, 125], [8, 9, 1, 200, 100, 205, 203],
                              [9, 9, 1, 210, 100, 215, 213]])
